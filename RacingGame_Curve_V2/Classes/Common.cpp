...
void ComCoordinate::setXYZ(double x, double y, double z, double w, double scale) {
	this->x = x;
	this->y = y;
	this->z = z;
	this->w = z;
...
double ComUtil::randomInt(double min, double max) {
...
double ComUtil::percentRemaining(int n, int total) {
